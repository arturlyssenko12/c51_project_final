...
def evaluate_mace(
    ...
    atoms_list = Trajectory(xyz_paths)
...
if __name__ == "__main__":
    e_t, e_p, f_t, f_p = evaluate_mace(
        "results_for_analysis/mace_small/101/traj.traj",
        model_path="/home/alyssenko/c51_project/MACE-OFF23_small.model",
        device="cuda:0",
        dt_fs=1.0,
        csv_path="results_for_analysis/mace_small/mace_small_inference_train_dat.csv",
    )
